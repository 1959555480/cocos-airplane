    ...
    execute: function () {
      ...
      _export("Bullet", Bullet = (_dec = ccclass("Bullet"), _dec(_class = (_class2 = class Bullet extends Component {
        ...
        update(deltaTime) {
          ...
          const moveLength = pos.y - this.bulletSpeed;
          this.node.setPosition(pos.x + 0.025, pos.y + 0.1, moveLength + 1.398);
...
//# sourceMappingURL=1e8b77f20aa6a355f682a933cf81388ffe3e3255.js.map